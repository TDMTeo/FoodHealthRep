...
namespace Clases
{
    ...
    partial void Deletepersonas(personas instance);
		...
		public DatosDataContext() : 
				base(global::Clases.Properties.Settings.Default.Prueba4ConnectionString1, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnRolIDChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Documento", DbType="VarChar(45) NOT NULL", CanBeNull=false)]
    ...
    partial void OnNombreRolChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_NombreRol", DbType="VarChar(45) NOT NULL", CanBeNull=false)]
