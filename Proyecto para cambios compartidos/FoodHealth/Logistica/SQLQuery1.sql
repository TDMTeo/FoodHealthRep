...
Domiciliario varchar(45), 
Cliente varchar(45) not null, 
Direccion varchar(45) not null,
constraint PK_Primary_Pedido primary key (PedidoID)
);
...
constraint FK_Cliente_Pedido foreign key (PedidoID) references Pedido (PedidoID)
);
...
constraint FK_Domiciliario_Pedido foreign key (PedidoID) references Pedido (PedidoID)
);
...
insert into Pedido (Descripcion,Domiciliario,Cliente,Direccion) values 
('Papas','Teo','Juan','Cr los calvos')
