<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registrarse.aspx.cs" Inherits="Logistica.Pruebas1" %>
          ...
          <div class="card-body">
            ...
            <form class="form-signin" runat="server">
              ...
              <div class="custom-control custom-checkbox mb-3">
                ...
                <asp:Button ID="Button1" CssClass="btn btn-lg btn btn-light btn-block text-uppercase" runat="server" Text="Registrarse" OnClick="Button1_Click" />
              <hr class="my-4"/>
                <asp:Button ID="Button2" CssClass="btn btn-lg btn-google btn-block text-uppercase" runat="server" Text="Inicio" OnClick="Button2_Click" />
                <asp:Button ID="Button3" CssClass="btn btn-lg btn-facebook btn-block text-uppercase" runat="server" Text="Iniciar Sesion" OnClick="Button3_Click" />
            </form>
          </div>
        </div>
      </div>
